  ...
  const watches = [
    {
      ...
      description:
        "Learn tips and tricks for watch collecting from novices to experts. Avoid costly mistakes and enjoy a smoother journey.Read our article now",
      src: "/latestnews1.png",
    },
    {
      ...
      description:
        "Jay was our 200th competition winner and walked away with the biggest win since our inception. This is Jay’s story.",
      src: "/latestnews2.png",
    },
    {
      ...
      description:
        "For our first American edition of Conversing with Collectors, we speak with the one-of-a-kind Jose Hardy about his watch journey.",
      src: "/latestnews3.png",
    },
  ];
  ...
  return (
    <section className="relative pb-8">
      ...
      <div className="relative z-10 text-center">
        <header className="flex w-full flex-col items-center gap-2 relative md:gap-4">
          <h4
            ...
            {watches.map((watch, index) => (
              <div key={index} className="overflow-hidden bg-white shadow-md">
                <Image
                  ...
                  width={300}
                  height={400}
                  className="w-full object-cover dream-image"
                />
